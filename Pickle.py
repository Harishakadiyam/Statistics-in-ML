...
#load the save model
model = pickle.load(open(r'C:\Users\Admin\AVScode\linear_regression_model.pkl',"rb"))
...
years_experience = st.number_input("Enter Years of Experience:", min_value=0.0, max_value=100.0, value=1.0, step=0.5)
